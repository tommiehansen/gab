	...
	if( $userConf )
	{
		...
		$conf['db_fields'] = [
			...
			'results' => [
				...
				'trades_win' => 'INTEGER NOT NULL',
				'trades_lose' => 'INTEGER NOT NULL',
				'trades_win_percent' => 'REAL NOT NULL',
				'trades_win_avg' => 'REAL NOT NULL',
				'trades_lose_avg' => 'REAL NOT NULL',
				'trades_best' => 'REAL NOT NULL',
				'trades_worst' => 'REAL NOT NULL',
